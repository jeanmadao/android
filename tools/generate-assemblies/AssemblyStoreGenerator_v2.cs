...
//
partial class AssemblyStoreGenerator_v2: AssemblyStoreGenerator
{
	...
	public AssemblyStoreGenerator_v2 (IList<AssemblyStoreExplorer> explorers)
	{
		Console.WriteLine(".NET9 APK detected!");
